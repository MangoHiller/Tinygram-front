...
exports.cacheDir = (0, find_cache_dir_1.default)({
    name: 'vuetify',
    create: true,
    thunk: true
});
function writeStyles(files) {
    return (0, promises_1.writeFile)((0, exports.cacheDir)('styles.scss'), ['vuetify/lib/styles/main.sass', ...files.values()].map(v => `@forward '${path.normalize(v)}';`).join('\n'), 'utf8');
}
