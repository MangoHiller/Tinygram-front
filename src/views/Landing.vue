...
<div id="leaves">
  ...
  <div>
    ...
    >
      ...
      <h1 style="color: white; font-weight: 800; font-style: normal; letter-spacing: 0.0892857143em">INSTA💚GREEN</h1>
      <h3 style="color: white; font-weight: 400">
        Rejoignez des milliers d'amoureux de la nature dès aujourd'hui !<br />Commencer en vous connectant avec Google!
      </h3>
...
<style scoped>
/*
  Feuilles tombantes animation 
  Source: https://codepen.io/uurrnn/pen/WNLVdN
*/
body {background: #222;}
